...
log = structlog.get_logger("tamara.llm")
...
class LLMEngine:
    ...
    def __init__(self):
        ...
        self._tools_config = get_settings().tools
    ...
    def set_tool_registry(self, registry) -> None:
        ...
        if self._tools_enabled:
            log.info("Tools enabled", tools=registry.tool_names)
    ...
    def add_tool_result(self, tool_name: str, result: str) -> None:
        ...
        """
        self._history.append({"role": "tool", "content": result, "name": tool_name})
    ...
    def chat_stream(self, user_message: str) -> Generator[str, None, str]:
        ...
        try:
            stream = ollama.chat(
                model=self._config.model, messages=self._history, stream=True
            )
            ...
            log.error("Ollama error", error=str(e))
            yield f"\n[Error: {error_msg}]"
        ...
        try:
            ...
            if tool_calls:
                ...
                for tool_call in tool_calls:
                    ...
                    log.info("Tool executed", tool=tool_name)
            ...
            log.error("Chat with tools failed", error=str(e))
    ...
    def set_model(self, model_name: str) -> None:
        ...
        log.info("Model changed", model=model_name)
